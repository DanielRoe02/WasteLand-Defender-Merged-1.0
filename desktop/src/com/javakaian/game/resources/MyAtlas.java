...
public class MyAtlas {
    ...
    public static Sprite WATER_TILE;
    public static Sprite POLLUTED_WATER_TILE;
    public static Sprite TOXIC_TILE;
    ...
    public static void init() {
        ...
        GRASS_TILE = new Sprite(new Texture(Gdx.files.internal("img/GrassLand.png")));
        PATH_TILE = createSprite(atlas.findRegion("path"));
        TOXIC_TILE = new Sprite(new Texture(Gdx.files.internal("img/ToxicBarrel.png")));
        WATER_TILE = new Sprite(new Texture(Gdx.files.internal("img/Water.png")));
        POLLUTED_WATER_TILE = new Sprite(new Texture(Gdx.files.internal("img/WaterPolluted.png")));
        GRASS_TILE.flip(false, true);
        TOXIC_TILE.flip(false, true);
