...
public class GameConstants {
	...
	public static float ENEMY_HEALTHBAR_HEIGHT = GRID_HEIGHT * 0.1f;
	public static float ENEMY_HEALTHBAR_OFFSET_Y = GRID_HEIGHT * 0.15f;


	public static float ENEMY_SPAWN_PERIOD = 1.5f;
